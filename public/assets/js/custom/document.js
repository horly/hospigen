...
function filterCabinets(query) {
    ...
    return cabinetsData.filter(cabinet => {
        return cabinet.titre.toLowerCase().includes(searchTerm) ||
                cabinet.reference.toLowerCase().includes(searchTerm);
    });
}
...
function displaySuggestions(suggestions, query) {
    ...
    suggestions.forEach(cabinet => {
        ...
        const highlightedNumber = highlightMatch(cabinet.titre, query);
        const highlightedDesc = highlightMatch(cabinet.reference, query);
